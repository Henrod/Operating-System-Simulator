...
import LinkedLists.DiskPartitionTable;
import LinkedLists.QueueLinkedList;

public class Disk extends Peripheral{
	
	public DiskPartitionTable diskPartitionTable;

	public Disk(int overhead_time, int max_wait_queue, int max_length_queue){
		this.occupied = false;
		...
		this.diskPartitionTable = new DiskPartitionTable();
	}
